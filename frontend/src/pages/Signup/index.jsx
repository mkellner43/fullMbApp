...
import { updateUsername, updateFirstName, updateLastName, updatePassword,
  setFirstNameError, setLastNameError, setPasswordError, setUsernameError,
  setMainError, setNotification } from './features/signUpSlice';
  ...
  return (
    <form className='center'>
      <div className="page-width-form center">
        ...
        {error && <Snackbar open={error ? true : false} onClose={handleClose} anchorOrigin={{ vertical: 'top', horizontal: 'center'}}>
        ...
        <Button sx={{m: 1}} variant='outlined' type='button' onClick={() => navigate('/login')}>
          Log In
        </Button>
      </div>
    </form>
