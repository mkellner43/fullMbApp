...
export const { updateFirstName, updateLastName, updateUsername, updatePassword, setFirstNameError, setLastNameError, setPasswordError, setUsernameError, setMainError,
setNotification } = signUpSlice.actions;
