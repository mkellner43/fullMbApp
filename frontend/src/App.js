...
// refactor stuff to make it pretty and also add comments for easy reading (:
...
// can reseed posts to have non random pics AND correctly seed IMG data see card note near img elm
